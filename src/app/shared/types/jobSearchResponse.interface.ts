...
export interface JobSearchResponseData {
  ...
  job_id: string;
  job_employment_type: JobEmploymentType | string;
  job_title: string;
  ...
  job_required_experience: JobRequiredExperience | string;
  job_required_skills: string[] | null;
  job_required_education: JobRequiredEducation | string;
  job_experience_in_place_of_education: boolean;
  job_min_salary: number | null;
  job_max_salary: number | null;
  job_salary_currency: null | string;
  job_salary_period: null | string;
  job_highlights: JobHighlights | string;
  job_job_title: null | string;
  job_posting_language: JobPostingLanguage | string;
  job_onet_soc: string;
